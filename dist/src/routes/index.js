...
const taskProgress_route_1 = __importDefault(require("./taskProgress.route"));
const banner_route_1 = __importDefault(require("./banner.route"));
const county_route_1 = __importDefault(require("./county.route"));
...
restRouter.use('/task', task_route_1.default);
restRouter.use('/task-progress', taskProgress_route_1.default);
restRouter.use('/banner', banner_route_1.default);
restRouter.use('/county', county_route_1.default);
